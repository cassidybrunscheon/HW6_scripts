...
sudo curl https://raw.githubusercontent.com/cassidybrunscheon/AzureVM/main/default | sudo tee -a /etc/nginx/sites-available/default
...
sudo git clone https://github.com/cassidybrunscheon/HW6_website.git
